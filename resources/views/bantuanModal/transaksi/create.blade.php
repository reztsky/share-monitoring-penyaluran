        ...
        <dl class="row">
            ...
            @if (!is_null($kpm->transaksi))
                ...
                <dl class="col-md-10 col-12">
                    ...
                    <img src="{{asset('storage/foto_pemberian/'.$foto)}}" alt="" class="img-thumbnail" style="max-width:200px;max-height:200px;object-fit:cover">
                    @endforeach
                </dl>
            @endif
        </dl>
            ...
            <div class="col-md-6 col-12">
                <form action="{{route('bantuanmodal.transaksi.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="file" class="form-control" name="" id="foto_pemberian" accept="image/*" multiple>

                        @error('foto_pemberian')<div class="form-text text-danger">{{$message}}</div>@enderror
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        @if (!is_null($kpm->transaksi))
                            <a href="{{route('bantuanmodal.transaksi.softDelete',$kpm->transaksi->id)}}" id="btn-delete" class="btn btn-danger btn-sm">Batalkan</a>
                        @endif
			...
			img.onload=function(){
				...
				canvas.toBlob(
					(blob) => {
						...
						var template=`<input type="file" name="foto_pemberian[]" id="compress-foto-${index}" multiple>`
