                    ...
                    <table class="table table-hover mb-0 text-left">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('bantuanmodal.monitoring.show',$monitoring->id)}}" class="col-md-3 btn btn-sm" style="background-color: #4CBCA1;height: 34px">
                                        <i class="bi bi-eye-fill white"></i>
                                    </a>
                                    <a href="#" class="col-md-3 btn btn-sm" style="background-color: #FFA17A;height: 34px">
                                        <i class="bi bi-pencil-fill white"></i>
                                    </a>
                                    <a class="col-md-3 btn btn-sm" style="background-color: #BC4C4C;color:white;height: 34px"
