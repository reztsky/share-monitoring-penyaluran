        ...
        <tbody id="items-tbody">
            @for ($i = 0; $i < count($detail->nama_barang); $i++)
                <tr>
                    ...
                    <td>
                        <input type="number" min=0 class="form-control" name="jumlah_terjual[{{$i+1}}]" value="{{$detail->jumlah_terjual[$i+1]}}" placeholder="Jumlah Terjual">
                    </td>
                    <td>
                        <input type="number" min=0 class="form-control" name="harga[{{$i+1}}]" value="{{$detail->harga[$i+1]}}">
                    </td>
                </tr>
            @endfor
        </tbody>
