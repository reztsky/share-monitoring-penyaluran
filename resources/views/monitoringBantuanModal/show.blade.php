            ...
            <div class="app-card-body">
                <div class="g-3">
                    ...
                    <div class="row mb-3 ">
                        ...
                        <p id="nik" class="bold col-sm-8 col-form-label form-label">{{$monitoring->kpm->nik}}</p>
                    </div>

                    <div class="row mb-3">
                        <label for="" class="col-sm-4 col-form-label">Nama Penerima</label>
                        <p id="nama_penerima" class="bold col-sm-8 col-form-label form-label">{{$monitoring->kpm->nama}}
                        </p>
                    </div>
                    <div class="row mb-3">
                        <label for="" class="col-sm-4 col-form-label">Alamat KTP</label>
                        <p id="alamat_ktp" class="bold col-sm-8 col-form-label form-label">{{$monitoring->kpm->alamat}}
                        </p>
                    </div>
                    <div class="row mb-3">
