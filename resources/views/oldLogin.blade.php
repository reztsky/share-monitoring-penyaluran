...
<body>
    ...
    <div class="position-relative">
        <div class="toast-container positon-absolute top-0 end-0  me-3 mt-4">
            <div class="toast shadow-lg border border-info border-1 show text-white bg-danger"
                            ...
                            <form method="post" action="{{route('auth')}}">
                                ...
                                <div class="form-outline form-white mb-4">
                                    <input type="text" id="username" name="username"
                                        class="form-control form-control-lg @error('usename') @enderror"
                                    ...
                                    <div class="col-md-6 col-12 col-sm-6">
                                        <div class="form-outline form-white mb-3 mt-1">
                                            <input type="text" id="capthca" name="captcha"
                                                class="form-control form-control-lg" placeholder="Captcha" />
