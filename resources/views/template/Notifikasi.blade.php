...
@if ($message=session('notifikasi_gagal'))
<div class="toast-container position-absolute p-3 top-0 end-0" style="z-index:999999;">
    <div class="toast show align-items-center text-white border-0" style="background-color: #c23737" role="alert" aria-live="assertive"
        aria-atomic="true">
        <div class="d-flex">
            <div class="toast-body">
                {{$message}}
