                    ...
                    <div class="app-card-body">
                        <div class="g-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <img src="{{asset('storage/dokumentasi_penyaluran/'.$pengajuan_kebutuhan->penyaluran->foto_penyaluran)}}" alt="" class="img-fluid img-thumbnail" style="object-fit: cover;width:150px">
                                </div>
                            </div>
